<header id="header">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                <div class="nav-toggle-wrapper text-right">
                    <button><img src="img/toggle.svg" alt=""></button>
                </div>
            </div>
        </div>
    </div>
    <div class="off-canvas-header-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="navbar-item-wrapper drop-item">
                        <ul>
                            <li><a href="services.php">AOG Maintenance</a></li>
        ...
        <button><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
