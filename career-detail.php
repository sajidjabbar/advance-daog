...
<!-- Header Include -->
<!-- Css Included Here -->
<link rel="stylesheet" href="css/career-detail.css">
...
<section class="career-detail-start">
    <div class="container">
        <div class="job-complete-details">
        ...
        <a href="apply-now.php" class="btn apply-now-btn">Apply Now</a>
    </div>
</section>
