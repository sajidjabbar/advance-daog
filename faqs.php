        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="content-wrapper">
                    <h1 data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">FAQs</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="accrodians-start">
                <div class="single-accordian">
                    <div>
                        <button class="the-accordian-button collapsed" type="button" data-toggle="collapse"
            ...
            <form method="POST">
                <div class="form-row">
                    ...
                    <div class="form-input mt-3">
                        ...
                        <input type="text" name="" class="form-control" placeholder="Write Organization Name"
                            id="lastname">
                    </div>
                </div>
                <div class="form-row">
