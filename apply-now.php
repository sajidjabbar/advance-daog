            ...
            <form method="POST">
                ...
                <div class="form-row">
                    <div class="form-input mt-3">
                        ...
                        <textarea name="" id="" class="form-control" placeholder="Why you feel you would be a great fit to join the
AdvanceDoag Team">
                        </textarea>
                    </div>
                    <div class="form-input mt-3">
                        <label for="lastname">Attach CV</label>
                        <label for="upload-cv">
                            <span class="upload-your-cv">Upload</span>
                            <input type="file" name="" id="upload-cv">
                        </label>
                    </div>
                </div>
